// cpu_intel_niosv_m_2240_jyazqvy.v
...
`timescale 1 ps / 1 ps
module cpu_intel_niosv_m_2240_jyazqvy (
	...
	cpu_altera_irq_mapper_2000_2cmrx4y irq_mapper (
		.clk           (clk),                      //   input,  width = 1,       clk.clk
	...
	cpu_altera_irq_mapper_2000_2cmrx4y irq_mapper_001 (
		.clk           (clk),                          //   input,  width = 1,       clk.clk
		.reset         (reset_reset),                  //   input,  width = 1, clk_reset.reset
	...
	cpu_altera_irq_mapper_2000_2cmrx4y irq_mapper_002 (
		.clk           (clk),                          //   input,  width = 1,       clk.clk
		.reset         (reset_reset),                  //   input,  width = 1, clk_reset.reset
