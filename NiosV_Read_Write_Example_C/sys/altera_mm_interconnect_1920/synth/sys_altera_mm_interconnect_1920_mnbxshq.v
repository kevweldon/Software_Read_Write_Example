// sys_altera_mm_interconnect_1920_mnbxshq.v
...
`timescale 1 ps / 1 ps
module sys_altera_mm_interconnect_1920_mnbxshq (
		...
		output wire [16:0] data_instruction_ram_s1_address,         //         data_instruction_ram_s1.address
		output wire        data_instruction_ram_s1_write,           //                                .write
		input  wire [31:0] data_instruction_ram_s1_readdata,        //                                .readdata
		output wire [31:0] data_instruction_ram_s1_writedata,       //                                .writedata
		output wire [3:0]  data_instruction_ram_s1_byteenable,      //                                .byteenable
		output wire        data_instruction_ram_s1_chipselect,      //                                .chipselect
		output wire        data_instruction_ram_s1_clken,           //                                .clken
		output wire [5:0]  ram_32bit_s1_address,                    //                    ram_32bit_s1.address
		output wire        ram_32bit_s1_write,                      //                                .write
		input  wire [31:0] ram_32bit_s1_readdata,                   //                                .readdata
		output wire [31:0] ram_32bit_s1_writedata,                  //                                .writedata
		output wire [3:0]  ram_32bit_s1_byteenable,                 //                                .byteenable
		output wire        ram_32bit_s1_chipselect,                 //                                .chipselect
		output wire        ram_32bit_s1_clken,                      //                                .clken
		output wire [1:0]  pio_8bit_s1_address,                     //                     pio_8bit_s1.address
		output wire        pio_8bit_s1_write,                       //                                .write
		input  wire [31:0] pio_8bit_s1_readdata,                    //                                .readdata
		output wire [31:0] pio_8bit_s1_writedata,                   //                                .writedata
		output wire        pio_8bit_s1_chipselect,                  //                                .chipselect
	...
	wire  [131:0] rsp_mux_src_data;                                                // rsp_mux:src_data -> cpu_data_manager_agent:write_rp_data
	wire          rsp_mux_src_ready;                                               // cpu_data_manager_agent:write_rp_ready -> rsp_mux:src_ready
	wire    [5:0] rsp_mux_src_channel;                                             // rsp_mux:src_channel -> cpu_data_manager_agent:write_rp_channel
	...
	wire  [131:0] rsp_mux_001_src_data;                                            // rsp_mux_001:src_data -> cpu_data_manager_agent:read_rp_data
	wire          rsp_mux_001_src_ready;                                           // cpu_data_manager_agent:read_rp_ready -> rsp_mux_001:src_ready
	wire    [5:0] rsp_mux_001_src_channel;                                         // rsp_mux_001:src_channel -> cpu_data_manager_agent:read_rp_channel
	...
	wire  [132:0] cpu_dm_agent_agent_rf_source_data;                               // cpu_dm_agent_agent:rf_source_data -> cpu_dm_agent_agent_rsp_fifo:in_data
	...
	wire  [132:0] cpu_dm_agent_agent_rsp_fifo_out_data;                            // cpu_dm_agent_agent_rsp_fifo:out_data -> cpu_dm_agent_agent:rf_sink_data
	...
	wire   [31:0] data_instruction_ram_s1_agent_m0_readdata;                       // data_instruction_ram_s1_translator:uav_readdata -> data_instruction_ram_s1_agent:m0_readdata
	wire          data_instruction_ram_s1_agent_m0_waitrequest;                    // data_instruction_ram_s1_translator:uav_waitrequest -> data_instruction_ram_s1_agent:m0_waitrequest
	wire          data_instruction_ram_s1_agent_m0_debugaccess;                    // data_instruction_ram_s1_agent:m0_debugaccess -> data_instruction_ram_s1_translator:uav_debugaccess
	wire   [31:0] data_instruction_ram_s1_agent_m0_address;                        // data_instruction_ram_s1_agent:m0_address -> data_instruction_ram_s1_translator:uav_address
	wire    [3:0] data_instruction_ram_s1_agent_m0_byteenable;                     // data_instruction_ram_s1_agent:m0_byteenable -> data_instruction_ram_s1_translator:uav_byteenable
	wire          data_instruction_ram_s1_agent_m0_read;                           // data_instruction_ram_s1_agent:m0_read -> data_instruction_ram_s1_translator:uav_read
	wire          data_instruction_ram_s1_agent_m0_readdatavalid;                  // data_instruction_ram_s1_translator:uav_readdatavalid -> data_instruction_ram_s1_agent:m0_readdatavalid
	wire          data_instruction_ram_s1_agent_m0_lock;                           // data_instruction_ram_s1_agent:m0_lock -> data_instruction_ram_s1_translator:uav_lock
	wire   [31:0] data_instruction_ram_s1_agent_m0_writedata;                      // data_instruction_ram_s1_agent:m0_writedata -> data_instruction_ram_s1_translator:uav_writedata
	wire          data_instruction_ram_s1_agent_m0_write;                          // data_instruction_ram_s1_agent:m0_write -> data_instruction_ram_s1_translator:uav_write
	wire    [2:0] data_instruction_ram_s1_agent_m0_burstcount;                     // data_instruction_ram_s1_agent:m0_burstcount -> data_instruction_ram_s1_translator:uav_burstcount
	wire          data_instruction_ram_s1_agent_rf_source_valid;                   // data_instruction_ram_s1_agent:rf_source_valid -> data_instruction_ram_s1_agent_rsp_fifo:in_valid
	wire  [132:0] data_instruction_ram_s1_agent_rf_source_data;                    // data_instruction_ram_s1_agent:rf_source_data -> data_instruction_ram_s1_agent_rsp_fifo:in_data
	wire          data_instruction_ram_s1_agent_rf_source_ready;                   // data_instruction_ram_s1_agent_rsp_fifo:in_ready -> data_instruction_ram_s1_agent:rf_source_ready
	wire          data_instruction_ram_s1_agent_rf_source_startofpacket;           // data_instruction_ram_s1_agent:rf_source_startofpacket -> data_instruction_ram_s1_agent_rsp_fifo:in_startofpacket
	wire          data_instruction_ram_s1_agent_rf_source_endofpacket;             // data_instruction_ram_s1_agent:rf_source_endofpacket -> data_instruction_ram_s1_agent_rsp_fifo:in_endofpacket
	wire          data_instruction_ram_s1_agent_rsp_fifo_out_valid;                // data_instruction_ram_s1_agent_rsp_fifo:out_valid -> data_instruction_ram_s1_agent:rf_sink_valid
	wire  [132:0] data_instruction_ram_s1_agent_rsp_fifo_out_data;                 // data_instruction_ram_s1_agent_rsp_fifo:out_data -> data_instruction_ram_s1_agent:rf_sink_data
	wire          data_instruction_ram_s1_agent_rsp_fifo_out_ready;                // data_instruction_ram_s1_agent:rf_sink_ready -> data_instruction_ram_s1_agent_rsp_fifo:out_ready
	wire          data_instruction_ram_s1_agent_rsp_fifo_out_startofpacket;        // data_instruction_ram_s1_agent_rsp_fifo:out_startofpacket -> data_instruction_ram_s1_agent:rf_sink_startofpacket
	wire          data_instruction_ram_s1_agent_rsp_fifo_out_endofpacket;          // data_instruction_ram_s1_agent_rsp_fifo:out_endofpacket -> data_instruction_ram_s1_agent:rf_sink_endofpacket
	wire          data_instruction_ram_s1_agent_rdata_fifo_src_valid;              // data_instruction_ram_s1_agent:rdata_fifo_src_valid -> data_instruction_ram_s1_agent_rdata_fifo:in_valid
	wire   [33:0] data_instruction_ram_s1_agent_rdata_fifo_src_data;               // data_instruction_ram_s1_agent:rdata_fifo_src_data -> data_instruction_ram_s1_agent_rdata_fifo:in_data
	wire          data_instruction_ram_s1_agent_rdata_fifo_src_ready;              // data_instruction_ram_s1_agent_rdata_fifo:in_ready -> data_instruction_ram_s1_agent:rdata_fifo_src_ready
	wire          data_instruction_ram_s1_agent_rdata_fifo_out_valid;              // data_instruction_ram_s1_agent_rdata_fifo:out_valid -> data_instruction_ram_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] data_instruction_ram_s1_agent_rdata_fifo_out_data;               // data_instruction_ram_s1_agent_rdata_fifo:out_data -> data_instruction_ram_s1_agent:rdata_fifo_sink_data
	wire          data_instruction_ram_s1_agent_rdata_fifo_out_ready;              // data_instruction_ram_s1_agent:rdata_fifo_sink_ready -> data_instruction_ram_s1_agent_rdata_fifo:out_ready
	wire   [31:0] ram_32bit_s1_agent_m0_readdata;                                  // ram_32bit_s1_translator:uav_readdata -> ram_32bit_s1_agent:m0_readdata
	wire          ram_32bit_s1_agent_m0_waitrequest;                               // ram_32bit_s1_translator:uav_waitrequest -> ram_32bit_s1_agent:m0_waitrequest
	wire          ram_32bit_s1_agent_m0_debugaccess;                               // ram_32bit_s1_agent:m0_debugaccess -> ram_32bit_s1_translator:uav_debugaccess
	wire   [31:0] ram_32bit_s1_agent_m0_address;                                   // ram_32bit_s1_agent:m0_address -> ram_32bit_s1_translator:uav_address
	wire    [3:0] ram_32bit_s1_agent_m0_byteenable;                                // ram_32bit_s1_agent:m0_byteenable -> ram_32bit_s1_translator:uav_byteenable
	wire          ram_32bit_s1_agent_m0_read;                                      // ram_32bit_s1_agent:m0_read -> ram_32bit_s1_translator:uav_read
	wire          ram_32bit_s1_agent_m0_readdatavalid;                             // ram_32bit_s1_translator:uav_readdatavalid -> ram_32bit_s1_agent:m0_readdatavalid
	wire          ram_32bit_s1_agent_m0_lock;                                      // ram_32bit_s1_agent:m0_lock -> ram_32bit_s1_translator:uav_lock
	wire   [31:0] ram_32bit_s1_agent_m0_writedata;                                 // ram_32bit_s1_agent:m0_writedata -> ram_32bit_s1_translator:uav_writedata
	wire          ram_32bit_s1_agent_m0_write;                                     // ram_32bit_s1_agent:m0_write -> ram_32bit_s1_translator:uav_write
	wire    [2:0] ram_32bit_s1_agent_m0_burstcount;                                // ram_32bit_s1_agent:m0_burstcount -> ram_32bit_s1_translator:uav_burstcount
	wire          ram_32bit_s1_agent_rf_source_valid;                              // ram_32bit_s1_agent:rf_source_valid -> ram_32bit_s1_agent_rsp_fifo:in_valid
	wire  [132:0] ram_32bit_s1_agent_rf_source_data;                               // ram_32bit_s1_agent:rf_source_data -> ram_32bit_s1_agent_rsp_fifo:in_data
	wire          ram_32bit_s1_agent_rf_source_ready;                              // ram_32bit_s1_agent_rsp_fifo:in_ready -> ram_32bit_s1_agent:rf_source_ready
	wire          ram_32bit_s1_agent_rf_source_startofpacket;                      // ram_32bit_s1_agent:rf_source_startofpacket -> ram_32bit_s1_agent_rsp_fifo:in_startofpacket
	wire          ram_32bit_s1_agent_rf_source_endofpacket;                        // ram_32bit_s1_agent:rf_source_endofpacket -> ram_32bit_s1_agent_rsp_fifo:in_endofpacket
	wire          ram_32bit_s1_agent_rsp_fifo_out_valid;                           // ram_32bit_s1_agent_rsp_fifo:out_valid -> ram_32bit_s1_agent:rf_sink_valid
	wire  [132:0] ram_32bit_s1_agent_rsp_fifo_out_data;                            // ram_32bit_s1_agent_rsp_fifo:out_data -> ram_32bit_s1_agent:rf_sink_data
	wire          ram_32bit_s1_agent_rsp_fifo_out_ready;                           // ram_32bit_s1_agent:rf_sink_ready -> ram_32bit_s1_agent_rsp_fifo:out_ready
	wire          ram_32bit_s1_agent_rsp_fifo_out_startofpacket;                   // ram_32bit_s1_agent_rsp_fifo:out_startofpacket -> ram_32bit_s1_agent:rf_sink_startofpacket
	wire          ram_32bit_s1_agent_rsp_fifo_out_endofpacket;                     // ram_32bit_s1_agent_rsp_fifo:out_endofpacket -> ram_32bit_s1_agent:rf_sink_endofpacket
	wire          ram_32bit_s1_agent_rdata_fifo_src_valid;                         // ram_32bit_s1_agent:rdata_fifo_src_valid -> ram_32bit_s1_agent_rdata_fifo:in_valid
	wire   [33:0] ram_32bit_s1_agent_rdata_fifo_src_data;                          // ram_32bit_s1_agent:rdata_fifo_src_data -> ram_32bit_s1_agent_rdata_fifo:in_data
	wire          ram_32bit_s1_agent_rdata_fifo_src_ready;                         // ram_32bit_s1_agent_rdata_fifo:in_ready -> ram_32bit_s1_agent:rdata_fifo_src_ready
	wire          ram_32bit_s1_agent_rdata_fifo_out_valid;                         // ram_32bit_s1_agent_rdata_fifo:out_valid -> ram_32bit_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] ram_32bit_s1_agent_rdata_fifo_out_data;                          // ram_32bit_s1_agent_rdata_fifo:out_data -> ram_32bit_s1_agent:rdata_fifo_sink_data
	wire          ram_32bit_s1_agent_rdata_fifo_out_ready;                         // ram_32bit_s1_agent:rdata_fifo_sink_ready -> ram_32bit_s1_agent_rdata_fifo:out_ready
	wire   [31:0] pio_8bit_s1_agent_m0_readdata;                                   // pio_8bit_s1_translator:uav_readdata -> pio_8bit_s1_agent:m0_readdata
	wire          pio_8bit_s1_agent_m0_waitrequest;                                // pio_8bit_s1_translator:uav_waitrequest -> pio_8bit_s1_agent:m0_waitrequest
	wire          pio_8bit_s1_agent_m0_debugaccess;                                // pio_8bit_s1_agent:m0_debugaccess -> pio_8bit_s1_translator:uav_debugaccess
	wire   [31:0] pio_8bit_s1_agent_m0_address;                                    // pio_8bit_s1_agent:m0_address -> pio_8bit_s1_translator:uav_address
	wire    [3:0] pio_8bit_s1_agent_m0_byteenable;                                 // pio_8bit_s1_agent:m0_byteenable -> pio_8bit_s1_translator:uav_byteenable
	wire          pio_8bit_s1_agent_m0_read;                                       // pio_8bit_s1_agent:m0_read -> pio_8bit_s1_translator:uav_read
	wire          pio_8bit_s1_agent_m0_readdatavalid;                              // pio_8bit_s1_translator:uav_readdatavalid -> pio_8bit_s1_agent:m0_readdatavalid
	wire          pio_8bit_s1_agent_m0_lock;                                       // pio_8bit_s1_agent:m0_lock -> pio_8bit_s1_translator:uav_lock
	wire   [31:0] pio_8bit_s1_agent_m0_writedata;                                  // pio_8bit_s1_agent:m0_writedata -> pio_8bit_s1_translator:uav_writedata
	wire          pio_8bit_s1_agent_m0_write;                                      // pio_8bit_s1_agent:m0_write -> pio_8bit_s1_translator:uav_write
	wire    [2:0] pio_8bit_s1_agent_m0_burstcount;                                 // pio_8bit_s1_agent:m0_burstcount -> pio_8bit_s1_translator:uav_burstcount
	wire          pio_8bit_s1_agent_rf_source_valid;                               // pio_8bit_s1_agent:rf_source_valid -> pio_8bit_s1_agent_rsp_fifo:in_valid
	wire  [132:0] pio_8bit_s1_agent_rf_source_data;                                // pio_8bit_s1_agent:rf_source_data -> pio_8bit_s1_agent_rsp_fifo:in_data
	wire          pio_8bit_s1_agent_rf_source_ready;                               // pio_8bit_s1_agent_rsp_fifo:in_ready -> pio_8bit_s1_agent:rf_source_ready
	wire          pio_8bit_s1_agent_rf_source_startofpacket;                       // pio_8bit_s1_agent:rf_source_startofpacket -> pio_8bit_s1_agent_rsp_fifo:in_startofpacket
	wire          pio_8bit_s1_agent_rf_source_endofpacket;                         // pio_8bit_s1_agent:rf_source_endofpacket -> pio_8bit_s1_agent_rsp_fifo:in_endofpacket
	wire          pio_8bit_s1_agent_rsp_fifo_out_valid;                            // pio_8bit_s1_agent_rsp_fifo:out_valid -> pio_8bit_s1_agent:rf_sink_valid
	wire  [132:0] pio_8bit_s1_agent_rsp_fifo_out_data;                             // pio_8bit_s1_agent_rsp_fifo:out_data -> pio_8bit_s1_agent:rf_sink_data
	wire          pio_8bit_s1_agent_rsp_fifo_out_ready;                            // pio_8bit_s1_agent:rf_sink_ready -> pio_8bit_s1_agent_rsp_fifo:out_ready
	wire          pio_8bit_s1_agent_rsp_fifo_out_startofpacket;                    // pio_8bit_s1_agent_rsp_fifo:out_startofpacket -> pio_8bit_s1_agent:rf_sink_startofpacket
	wire          pio_8bit_s1_agent_rsp_fifo_out_endofpacket;                      // pio_8bit_s1_agent_rsp_fifo:out_endofpacket -> pio_8bit_s1_agent:rf_sink_endofpacket
	wire          pio_8bit_s1_agent_rdata_fifo_src_valid;                          // pio_8bit_s1_agent:rdata_fifo_src_valid -> pio_8bit_s1_agent_rdata_fifo:in_valid
	wire   [33:0] pio_8bit_s1_agent_rdata_fifo_src_data;                           // pio_8bit_s1_agent:rdata_fifo_src_data -> pio_8bit_s1_agent_rdata_fifo:in_data
	wire          pio_8bit_s1_agent_rdata_fifo_src_ready;                          // pio_8bit_s1_agent_rdata_fifo:in_ready -> pio_8bit_s1_agent:rdata_fifo_src_ready
	wire          pio_8bit_s1_agent_rdata_fifo_out_valid;                          // pio_8bit_s1_agent_rdata_fifo:out_valid -> pio_8bit_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] pio_8bit_s1_agent_rdata_fifo_out_data;                           // pio_8bit_s1_agent_rdata_fifo:out_data -> pio_8bit_s1_agent:rdata_fifo_sink_data
	wire          pio_8bit_s1_agent_rdata_fifo_out_ready;                          // pio_8bit_s1_agent:rdata_fifo_sink_ready -> pio_8bit_s1_agent_rdata_fifo:out_ready
	...
	wire  [132:0] cpu_timer_sw_agent_agent_rf_source_data;                         // cpu_timer_sw_agent_agent:rf_source_data -> cpu_timer_sw_agent_agent_rsp_fifo:in_data
	...
	wire  [132:0] cpu_timer_sw_agent_agent_rsp_fifo_out_data;                      // cpu_timer_sw_agent_agent_rsp_fifo:out_data -> cpu_timer_sw_agent_agent:rf_sink_data
	...
	wire  [131:0] cpu_data_manager_agent_write_cp_data;                            // cpu_data_manager_agent:write_cp_data -> router:sink_data
	...
	wire  [131:0] cpu_data_manager_agent_read_cp_data;                             // cpu_data_manager_agent:read_cp_data -> router_001:sink_data
	...
	wire  [131:0] cpu_instruction_manager_agent_write_cp_data;                     // cpu_instruction_manager_agent:write_cp_data -> router_002:sink_data
	...
	wire  [131:0] cpu_instruction_manager_agent_read_cp_data;                      // cpu_instruction_manager_agent:read_cp_data -> router_003:sink_data
	...
	wire  [131:0] jtag_uart_avalon_jtag_slave_agent_rp_data;                       // jtag_uart_avalon_jtag_slave_agent:rp_data -> router_004:sink_data
	...
	wire  [131:0] router_004_src_data;                                             // router_004:src_data -> rsp_demux:sink_data
	...
	wire  [131:0] cpu_dm_agent_agent_rp_data;                                      // cpu_dm_agent_agent:rp_data -> router_005:sink_data
	...
	wire  [131:0] router_005_src_data;                                             // router_005:src_data -> rsp_demux_001:sink_data
	...
	wire          data_instruction_ram_s1_agent_rp_valid;                          // data_instruction_ram_s1_agent:rp_valid -> router_006:sink_valid
	wire  [131:0] data_instruction_ram_s1_agent_rp_data;                           // data_instruction_ram_s1_agent:rp_data -> router_006:sink_data
	wire          data_instruction_ram_s1_agent_rp_ready;                          // router_006:sink_ready -> data_instruction_ram_s1_agent:rp_ready
	wire          data_instruction_ram_s1_agent_rp_startofpacket;                  // data_instruction_ram_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire          data_instruction_ram_s1_agent_rp_endofpacket;                    // data_instruction_ram_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	wire          router_006_src_valid;                                            // router_006:src_valid -> rsp_demux_002:sink_valid
	wire  [131:0] router_006_src_data;                                             // router_006:src_data -> rsp_demux_002:sink_data
	...
	wire          ram_32bit_s1_agent_rp_valid;                                     // ram_32bit_s1_agent:rp_valid -> router_007:sink_valid
	wire  [131:0] ram_32bit_s1_agent_rp_data;                                      // ram_32bit_s1_agent:rp_data -> router_007:sink_data
	wire          ram_32bit_s1_agent_rp_ready;                                     // router_007:sink_ready -> ram_32bit_s1_agent:rp_ready
	wire          ram_32bit_s1_agent_rp_startofpacket;                             // ram_32bit_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire          ram_32bit_s1_agent_rp_endofpacket;                               // ram_32bit_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	wire          router_007_src_valid;                                            // router_007:src_valid -> rsp_demux_003:sink_valid
	wire  [131:0] router_007_src_data;                                             // router_007:src_data -> rsp_demux_003:sink_data
	...
	wire          pio_8bit_s1_agent_rp_valid;                                      // pio_8bit_s1_agent:rp_valid -> router_008:sink_valid
	wire  [131:0] pio_8bit_s1_agent_rp_data;                                       // pio_8bit_s1_agent:rp_data -> router_008:sink_data
	wire          pio_8bit_s1_agent_rp_ready;                                      // router_008:sink_ready -> pio_8bit_s1_agent:rp_ready
	wire          pio_8bit_s1_agent_rp_startofpacket;                              // pio_8bit_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire          pio_8bit_s1_agent_rp_endofpacket;                                // pio_8bit_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	wire          router_008_src_valid;                                            // router_008:src_valid -> rsp_demux_004:sink_valid
	wire  [131:0] router_008_src_data;                                             // router_008:src_data -> rsp_demux_004:sink_data
	...
	wire          cpu_timer_sw_agent_agent_rp_valid;                               // cpu_timer_sw_agent_agent:rp_valid -> router_009:sink_valid
	wire  [131:0] cpu_timer_sw_agent_agent_rp_data;                                // cpu_timer_sw_agent_agent:rp_data -> router_009:sink_data
	wire          cpu_timer_sw_agent_agent_rp_ready;                               // router_009:sink_ready -> cpu_timer_sw_agent_agent:rp_ready
	wire          cpu_timer_sw_agent_agent_rp_startofpacket;                       // cpu_timer_sw_agent_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire          cpu_timer_sw_agent_agent_rp_endofpacket;                         // cpu_timer_sw_agent_agent:rp_endofpacket -> router_009:sink_endofpacket
	wire          router_009_src_valid;                                            // router_009:src_valid -> rsp_demux_005:sink_valid
	wire  [131:0] router_009_src_data;                                             // router_009:src_data -> rsp_demux_005:sink_data
	...
	wire  [131:0] router_002_src_data;                                             // router_002:src_data -> cpu_instruction_manager_wr_limiter:cmd_sink_data
	wire          router_002_src_ready;                                            // cpu_instruction_manager_wr_limiter:cmd_sink_ready -> router_002:src_ready
	wire    [5:0] router_002_src_channel;                                          // router_002:src_channel -> cpu_instruction_manager_wr_limiter:cmd_sink_channel
	...
	wire  [131:0] cpu_instruction_manager_wr_limiter_cmd_src_data;                 // cpu_instruction_manager_wr_limiter:cmd_src_data -> cmd_demux_002:sink_data
	...
	wire    [5:0] cpu_instruction_manager_wr_limiter_cmd_src_channel;              // cpu_instruction_manager_wr_limiter:cmd_src_channel -> cmd_demux_002:sink_channel
	...
	wire  [131:0] rsp_mux_002_src_data;                                            // rsp_mux_002:src_data -> cpu_instruction_manager_wr_limiter:rsp_sink_data
	wire          rsp_mux_002_src_ready;                                           // cpu_instruction_manager_wr_limiter:rsp_sink_ready -> rsp_mux_002:src_ready
	wire    [5:0] rsp_mux_002_src_channel;                                         // rsp_mux_002:src_channel -> cpu_instruction_manager_wr_limiter:rsp_sink_channel
	...
	wire  [131:0] cpu_instruction_manager_wr_limiter_rsp_src_data;                 // cpu_instruction_manager_wr_limiter:rsp_src_data -> cpu_instruction_manager_agent:write_rp_data
	...
	wire    [5:0] cpu_instruction_manager_wr_limiter_rsp_src_channel;              // cpu_instruction_manager_wr_limiter:rsp_src_channel -> cpu_instruction_manager_agent:write_rp_channel
	...
	wire  [131:0] router_003_src_data;                                             // router_003:src_data -> cpu_instruction_manager_rd_limiter:cmd_sink_data
	wire          router_003_src_ready;                                            // cpu_instruction_manager_rd_limiter:cmd_sink_ready -> router_003:src_ready
	wire    [5:0] router_003_src_channel;                                          // router_003:src_channel -> cpu_instruction_manager_rd_limiter:cmd_sink_channel
	...
	wire  [131:0] cpu_instruction_manager_rd_limiter_cmd_src_data;                 // cpu_instruction_manager_rd_limiter:cmd_src_data -> cmd_demux_003:sink_data
	...
	wire    [5:0] cpu_instruction_manager_rd_limiter_cmd_src_channel;              // cpu_instruction_manager_rd_limiter:cmd_src_channel -> cmd_demux_003:sink_channel
	...
	wire  [131:0] rsp_mux_003_src_data;                                            // rsp_mux_003:src_data -> cpu_instruction_manager_rd_limiter:rsp_sink_data
	wire          rsp_mux_003_src_ready;                                           // cpu_instruction_manager_rd_limiter:rsp_sink_ready -> rsp_mux_003:src_ready
	wire    [5:0] rsp_mux_003_src_channel;                                         // rsp_mux_003:src_channel -> cpu_instruction_manager_rd_limiter:rsp_sink_channel
	...
	wire  [131:0] cpu_instruction_manager_rd_limiter_rsp_src_data;                 // cpu_instruction_manager_rd_limiter:rsp_src_data -> cpu_instruction_manager_agent:read_rp_data
	...
	wire    [5:0] cpu_instruction_manager_rd_limiter_rsp_src_channel;              // cpu_instruction_manager_rd_limiter:rsp_src_channel -> cpu_instruction_manager_agent:read_rp_channel
	...
	wire  [131:0] cmd_mux_src_data;                                                // cmd_mux:src_data -> jtag_uart_avalon_jtag_slave_burst_adapter:sink0_data
	...
	wire          cmd_mux_001_src_valid;                                           // cmd_mux_001:src_valid -> cpu_dm_agent_burst_adapter:sink0_valid
	wire  [131:0] cmd_mux_001_src_data;                                            // cmd_mux_001:src_data -> cpu_dm_agent_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                           // cpu_dm_agent_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [5:0] cmd_mux_001_src_channel;                                         // cmd_mux_001:src_channel -> cpu_dm_agent_burst_adapter:sink0_channel
	wire          cmd_mux_001_src_startofpacket;                                   // cmd_mux_001:src_startofpacket -> cpu_dm_agent_burst_adapter:sink0_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                     // cmd_mux_001:src_endofpacket -> cpu_dm_agent_burst_adapter:sink0_endofpacket
	wire          cpu_dm_agent_burst_adapter_source0_valid;                        // cpu_dm_agent_burst_adapter:source0_valid -> cpu_dm_agent_agent:cp_valid
	wire  [131:0] cpu_dm_agent_burst_adapter_source0_data;                         // cpu_dm_agent_burst_adapter:source0_data -> cpu_dm_agent_agent:cp_data
	wire          cpu_dm_agent_burst_adapter_source0_ready;                        // cpu_dm_agent_agent:cp_ready -> cpu_dm_agent_burst_adapter:source0_ready
	wire    [5:0] cpu_dm_agent_burst_adapter_source0_channel;                      // cpu_dm_agent_burst_adapter:source0_channel -> cpu_dm_agent_agent:cp_channel
	...
	wire          cmd_mux_002_src_valid;                                           // cmd_mux_002:src_valid -> data_instruction_ram_s1_burst_adapter:sink0_valid
	wire  [131:0] cmd_mux_002_src_data;                                            // cmd_mux_002:src_data -> data_instruction_ram_s1_burst_adapter:sink0_data
	wire          cmd_mux_002_src_ready;                                           // data_instruction_ram_s1_burst_adapter:sink0_ready -> cmd_mux_002:src_ready
	wire    [5:0] cmd_mux_002_src_channel;                                         // cmd_mux_002:src_channel -> data_instruction_ram_s1_burst_adapter:sink0_channel
	wire          cmd_mux_002_src_startofpacket;                                   // cmd_mux_002:src_startofpacket -> data_instruction_ram_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_002_src_endofpacket;                                     // cmd_mux_002:src_endofpacket -> data_instruction_ram_s1_burst_adapter:sink0_endofpacket
	wire          data_instruction_ram_s1_burst_adapter_source0_valid;             // data_instruction_ram_s1_burst_adapter:source0_valid -> data_instruction_ram_s1_agent:cp_valid
	wire  [131:0] data_instruction_ram_s1_burst_adapter_source0_data;              // data_instruction_ram_s1_burst_adapter:source0_data -> data_instruction_ram_s1_agent:cp_data
	wire          data_instruction_ram_s1_burst_adapter_source0_ready;             // data_instruction_ram_s1_agent:cp_ready -> data_instruction_ram_s1_burst_adapter:source0_ready
	wire    [5:0] data_instruction_ram_s1_burst_adapter_source0_channel;           // data_instruction_ram_s1_burst_adapter:source0_channel -> data_instruction_ram_s1_agent:cp_channel
	wire          data_instruction_ram_s1_burst_adapter_source0_startofpacket;     // data_instruction_ram_s1_burst_adapter:source0_startofpacket -> data_instruction_ram_s1_agent:cp_startofpacket
	wire          data_instruction_ram_s1_burst_adapter_source0_endofpacket;       // data_instruction_ram_s1_burst_adapter:source0_endofpacket -> data_instruction_ram_s1_agent:cp_endofpacket
	wire          cmd_mux_003_src_valid;                                           // cmd_mux_003:src_valid -> ram_32bit_s1_burst_adapter:sink0_valid
	wire  [131:0] cmd_mux_003_src_data;                                            // cmd_mux_003:src_data -> ram_32bit_s1_burst_adapter:sink0_data
	wire          cmd_mux_003_src_ready;                                           // ram_32bit_s1_burst_adapter:sink0_ready -> cmd_mux_003:src_ready
	wire    [5:0] cmd_mux_003_src_channel;                                         // cmd_mux_003:src_channel -> ram_32bit_s1_burst_adapter:sink0_channel
	wire          cmd_mux_003_src_startofpacket;                                   // cmd_mux_003:src_startofpacket -> ram_32bit_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_003_src_endofpacket;                                     // cmd_mux_003:src_endofpacket -> ram_32bit_s1_burst_adapter:sink0_endofpacket
	wire          ram_32bit_s1_burst_adapter_source0_valid;                        // ram_32bit_s1_burst_adapter:source0_valid -> ram_32bit_s1_agent:cp_valid
	wire  [131:0] ram_32bit_s1_burst_adapter_source0_data;                         // ram_32bit_s1_burst_adapter:source0_data -> ram_32bit_s1_agent:cp_data
	wire          ram_32bit_s1_burst_adapter_source0_ready;                        // ram_32bit_s1_agent:cp_ready -> ram_32bit_s1_burst_adapter:source0_ready
	wire    [5:0] ram_32bit_s1_burst_adapter_source0_channel;                      // ram_32bit_s1_burst_adapter:source0_channel -> ram_32bit_s1_agent:cp_channel
	wire          ram_32bit_s1_burst_adapter_source0_startofpacket;                // ram_32bit_s1_burst_adapter:source0_startofpacket -> ram_32bit_s1_agent:cp_startofpacket
	wire          ram_32bit_s1_burst_adapter_source0_endofpacket;                  // ram_32bit_s1_burst_adapter:source0_endofpacket -> ram_32bit_s1_agent:cp_endofpacket
	wire          cmd_mux_004_src_valid;                                           // cmd_mux_004:src_valid -> pio_8bit_s1_burst_adapter:sink0_valid
	wire  [131:0] cmd_mux_004_src_data;                                            // cmd_mux_004:src_data -> pio_8bit_s1_burst_adapter:sink0_data
	wire          cmd_mux_004_src_ready;                                           // pio_8bit_s1_burst_adapter:sink0_ready -> cmd_mux_004:src_ready
	wire    [5:0] cmd_mux_004_src_channel;                                         // cmd_mux_004:src_channel -> pio_8bit_s1_burst_adapter:sink0_channel
	wire          cmd_mux_004_src_startofpacket;                                   // cmd_mux_004:src_startofpacket -> pio_8bit_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                     // cmd_mux_004:src_endofpacket -> pio_8bit_s1_burst_adapter:sink0_endofpacket
	wire          pio_8bit_s1_burst_adapter_source0_valid;                         // pio_8bit_s1_burst_adapter:source0_valid -> pio_8bit_s1_agent:cp_valid
	wire  [131:0] pio_8bit_s1_burst_adapter_source0_data;                          // pio_8bit_s1_burst_adapter:source0_data -> pio_8bit_s1_agent:cp_data
	wire          pio_8bit_s1_burst_adapter_source0_ready;                         // pio_8bit_s1_agent:cp_ready -> pio_8bit_s1_burst_adapter:source0_ready
	wire    [5:0] pio_8bit_s1_burst_adapter_source0_channel;                       // pio_8bit_s1_burst_adapter:source0_channel -> pio_8bit_s1_agent:cp_channel
	wire          pio_8bit_s1_burst_adapter_source0_startofpacket;                 // pio_8bit_s1_burst_adapter:source0_startofpacket -> pio_8bit_s1_agent:cp_startofpacket
	wire          pio_8bit_s1_burst_adapter_source0_endofpacket;                   // pio_8bit_s1_burst_adapter:source0_endofpacket -> pio_8bit_s1_agent:cp_endofpacket
	wire          cmd_mux_005_src_valid;                                           // cmd_mux_005:src_valid -> cpu_timer_sw_agent_burst_adapter:sink0_valid
	wire  [131:0] cmd_mux_005_src_data;                                            // cmd_mux_005:src_data -> cpu_timer_sw_agent_burst_adapter:sink0_data
	wire          cmd_mux_005_src_ready;                                           // cpu_timer_sw_agent_burst_adapter:sink0_ready -> cmd_mux_005:src_ready
	wire    [5:0] cmd_mux_005_src_channel;                                         // cmd_mux_005:src_channel -> cpu_timer_sw_agent_burst_adapter:sink0_channel
	wire          cmd_mux_005_src_startofpacket;                                   // cmd_mux_005:src_startofpacket -> cpu_timer_sw_agent_burst_adapter:sink0_startofpacket
	wire          cmd_mux_005_src_endofpacket;                                     // cmd_mux_005:src_endofpacket -> cpu_timer_sw_agent_burst_adapter:sink0_endofpacket
	...
	wire  [131:0] cpu_timer_sw_agent_burst_adapter_source0_data;                   // cpu_timer_sw_agent_burst_adapter:source0_data -> cpu_timer_sw_agent_agent:cp_data
	...
	wire    [5:0] cpu_timer_sw_agent_burst_adapter_source0_channel;                // cpu_timer_sw_agent_burst_adapter:source0_channel -> cpu_timer_sw_agent_agent:cp_channel
	...
	wire  [131:0] cmd_demux_002_src0_data;                                         // cmd_demux_002:src0_data -> cmd_mux_001:sink2_data
	...
	wire  [131:0] cmd_demux_002_src1_data;                                         // cmd_demux_002:src1_data -> cmd_mux_002:sink2_data
	...
	wire  [131:0] cmd_demux_003_src0_data;                                         // cmd_demux_003:src0_data -> cmd_mux_001:sink3_data
	...
	wire  [131:0] cmd_demux_003_src1_data;                                         // cmd_demux_003:src1_data -> cmd_mux_002:sink3_data
	...
	wire  [131:0] rsp_demux_001_src2_data;                                         // rsp_demux_001:src2_data -> rsp_mux_002:sink0_data
	...
	wire  [131:0] rsp_demux_001_src3_data;                                         // rsp_demux_001:src3_data -> rsp_mux_003:sink0_data
	...
	wire  [131:0] rsp_demux_002_src2_data;                                         // rsp_demux_002:src2_data -> rsp_mux_002:sink1_data
	...
	wire  [131:0] rsp_demux_002_src3_data;                                         // rsp_demux_002:src3_data -> rsp_mux_003:sink1_data
	...
	wire    [5:0] cpu_instruction_manager_wr_limiter_cmd_valid_data;               // cpu_instruction_manager_wr_limiter:cmd_src_valid -> cmd_demux_002:sink_valid
	wire    [5:0] cpu_instruction_manager_rd_limiter_cmd_valid_data;               // cpu_instruction_manager_rd_limiter:cmd_src_valid -> cmd_demux_003:sink_valid

	sys_altera_merlin_axi_translator_1921_uetfduq #(
		.USE_S0_AWID                       (0),
		.USE_S0_AWREGION                   (0),
		.USE_M0_AWREGION                   (1),
		.USE_S0_AWLEN                      (0),
	...
	sys_altera_merlin_slave_translator_191_x56fcki #(
		...
		.WAITREQUEST_ALLOWANCE          (0),
		.SYNC_RESET                     (0)
	) data_instruction_ram_s1_translator (
		.clk                    (clock_in_out_clk_clk),                           //   input,   width = 1,                      clk.clk
		.reset                  (cpu_reset_reset_bridge_in_reset_reset),          //   input,   width = 1,                    reset.reset
		.uav_address            (data_instruction_ram_s1_agent_m0_address),       //   input,  width = 32, avalon_universal_slave_0.address
		.uav_burstcount         (data_instruction_ram_s1_agent_m0_burstcount),    //   input,   width = 3,                         .burstcount
		.uav_read               (data_instruction_ram_s1_agent_m0_read),          //   input,   width = 1,                         .read
		.uav_write              (data_instruction_ram_s1_agent_m0_write),         //   input,   width = 1,                         .write
		.uav_waitrequest        (data_instruction_ram_s1_agent_m0_waitrequest),   //  output,   width = 1,                         .waitrequest
		.uav_readdatavalid      (data_instruction_ram_s1_agent_m0_readdatavalid), //  output,   width = 1,                         .readdatavalid
		.uav_byteenable         (data_instruction_ram_s1_agent_m0_byteenable),    //   input,   width = 4,                         .byteenable
		.uav_readdata           (data_instruction_ram_s1_agent_m0_readdata),      //  output,  width = 32,                         .readdata
		.uav_writedata          (data_instruction_ram_s1_agent_m0_writedata),     //   input,  width = 32,                         .writedata
		.uav_lock               (data_instruction_ram_s1_agent_m0_lock),          //   input,   width = 1,                         .lock
		.uav_debugaccess        (data_instruction_ram_s1_agent_m0_debugaccess),   //   input,   width = 1,                         .debugaccess
		.av_address             (data_instruction_ram_s1_address),                //  output,  width = 17,      avalon_anti_slave_0.address
		.av_write               (data_instruction_ram_s1_write),                  //  output,   width = 1,                         .write
		.av_readdata            (data_instruction_ram_s1_readdata),               //   input,  width = 32,                         .readdata
		.av_writedata           (data_instruction_ram_s1_writedata),              //  output,  width = 32,                         .writedata
		.av_byteenable          (data_instruction_ram_s1_byteenable),             //  output,   width = 4,                         .byteenable
		.av_chipselect          (data_instruction_ram_s1_chipselect),             //  output,   width = 1,                         .chipselect
		.av_clken               (data_instruction_ram_s1_clken),                  //  output,   width = 1,                         .clken
		.av_read                (),                                               // (terminated),                                       
		.av_begintransfer       (),                                               // (terminated),                                       
		.av_beginbursttransfer  (),                                               // (terminated),                                       
		.av_burstcount          (),                                               // (terminated),                                       
	...
	sys_altera_merlin_slave_translator_191_x56fcki #(
		...
		.WAITREQUEST_ALLOWANCE          (0),
		.SYNC_RESET                     (0)
	) ram_32bit_s1_translator (
		.clk                    (clock_in_out_clk_clk),                  //   input,   width = 1,                      clk.clk
		.reset                  (cpu_reset_reset_bridge_in_reset_reset), //   input,   width = 1,                    reset.reset
		.uav_address            (ram_32bit_s1_agent_m0_address),         //   input,  width = 32, avalon_universal_slave_0.address
		.uav_burstcount         (ram_32bit_s1_agent_m0_burstcount),      //   input,   width = 3,                         .burstcount
		.uav_read               (ram_32bit_s1_agent_m0_read),            //   input,   width = 1,                         .read
		.uav_write              (ram_32bit_s1_agent_m0_write),           //   input,   width = 1,                         .write
		.uav_waitrequest        (ram_32bit_s1_agent_m0_waitrequest),     //  output,   width = 1,                         .waitrequest
		.uav_readdatavalid      (ram_32bit_s1_agent_m0_readdatavalid),   //  output,   width = 1,                         .readdatavalid
		.uav_byteenable         (ram_32bit_s1_agent_m0_byteenable),      //   input,   width = 4,                         .byteenable
		.uav_readdata           (ram_32bit_s1_agent_m0_readdata),        //  output,  width = 32,                         .readdata
		.uav_writedata          (ram_32bit_s1_agent_m0_writedata),       //   input,  width = 32,                         .writedata
		.uav_lock               (ram_32bit_s1_agent_m0_lock),            //   input,   width = 1,                         .lock
		.uav_debugaccess        (ram_32bit_s1_agent_m0_debugaccess),     //   input,   width = 1,                         .debugaccess
		.av_address             (ram_32bit_s1_address),                  //  output,   width = 6,      avalon_anti_slave_0.address
		.av_write               (ram_32bit_s1_write),                    //  output,   width = 1,                         .write
		.av_readdata            (ram_32bit_s1_readdata),                 //   input,  width = 32,                         .readdata
		.av_writedata           (ram_32bit_s1_writedata),                //  output,  width = 32,                         .writedata
		.av_byteenable          (ram_32bit_s1_byteenable),               //  output,   width = 4,                         .byteenable
		.av_chipselect          (ram_32bit_s1_chipselect),               //  output,   width = 1,                         .chipselect
		.av_clken               (ram_32bit_s1_clken),                    //  output,   width = 1,                         .clken
		.av_read                (),                                      // (terminated),                                       
		.av_begintransfer       (),                                      // (terminated),                                       
		.av_beginbursttransfer  (),                                      // (terminated),                                       
		.av_burstcount          (),                                      // (terminated),                                       
	...
	sys_altera_merlin_slave_translator_191_x56fcki #(
		...
		.WAITREQUEST_ALLOWANCE          (0),
		.SYNC_RESET                     (0)
	) pio_8bit_s1_translator (
		.clk                    (clock_in_out_clk_clk),                  //   input,   width = 1,                      clk.clk
		.reset                  (cpu_reset_reset_bridge_in_reset_reset), //   input,   width = 1,                    reset.reset
		.uav_address            (pio_8bit_s1_agent_m0_address),          //   input,  width = 32, avalon_universal_slave_0.address
		.uav_burstcount         (pio_8bit_s1_agent_m0_burstcount),       //   input,   width = 3,                         .burstcount
		.uav_read               (pio_8bit_s1_agent_m0_read),             //   input,   width = 1,                         .read
		.uav_write              (pio_8bit_s1_agent_m0_write),            //   input,   width = 1,                         .write
		.uav_waitrequest        (pio_8bit_s1_agent_m0_waitrequest),      //  output,   width = 1,                         .waitrequest
		.uav_readdatavalid      (pio_8bit_s1_agent_m0_readdatavalid),    //  output,   width = 1,                         .readdatavalid
		.uav_byteenable         (pio_8bit_s1_agent_m0_byteenable),       //   input,   width = 4,                         .byteenable
		.uav_readdata           (pio_8bit_s1_agent_m0_readdata),         //  output,  width = 32,                         .readdata
		.uav_writedata          (pio_8bit_s1_agent_m0_writedata),        //   input,  width = 32,                         .writedata
		.uav_lock               (pio_8bit_s1_agent_m0_lock),             //   input,   width = 1,                         .lock
		.uav_debugaccess        (pio_8bit_s1_agent_m0_debugaccess),      //   input,   width = 1,                         .debugaccess
		.av_address             (pio_8bit_s1_address),                   //  output,   width = 2,      avalon_anti_slave_0.address
		.av_write               (pio_8bit_s1_write),                     //  output,   width = 1,                         .write
		.av_readdata            (pio_8bit_s1_readdata),                  //   input,  width = 32,                         .readdata
		.av_writedata           (pio_8bit_s1_writedata),                 //  output,  width = 32,                         .writedata
		.av_chipselect          (pio_8bit_s1_chipselect),                //  output,   width = 1,                         .chipselect
		.av_read                (),                                      // (terminated),                                       
		.av_begintransfer       (),                                      // (terminated),                                       
		.av_beginbursttransfer  (),                                      // (terminated),                                       
		.av_burstcount          (),                                      // (terminated),                                       
	...
	sys_altera_merlin_axi_master_ni_1941_dfsyzvi #(
		.ID_WIDTH                  (1),
		.ADDR_WIDTH                (32),
		.RDATA_WIDTH               (32),
		.WDATA_WIDTH               (32),
		...
		.write_cp_data          (cpu_data_manager_agent_write_cp_data),          //  output,  width = 132,                 .data
		...
		.read_cp_data           (cpu_data_manager_agent_read_cp_data),           //  output,  width = 132,                 .data
	...
	sys_altera_merlin_axi_master_ni_1941_dfsyzvi #(
		...
		.write_cp_data          (cpu_instruction_manager_agent_write_cp_data),              //  output,  width = 132,                 .data
		...
		.write_rp_data          (cpu_instruction_manager_wr_limiter_rsp_src_data),          //   input,  width = 132,                 .data
		.write_rp_channel       (cpu_instruction_manager_wr_limiter_rsp_src_channel),       //   input,    width = 6,                 .channel
		...
		.read_cp_data           (cpu_instruction_manager_agent_read_cp_data),               //  output,  width = 132,                 .data
		...
		.read_rp_data           (cpu_instruction_manager_rd_limiter_rsp_src_data),          //   input,  width = 132,                 .data
		.read_rp_channel        (cpu_instruction_manager_rd_limiter_rsp_src_channel),       //   input,    width = 6,                 .channel
	...
	sys_altera_merlin_slave_agent_191_ncfkfri #(
		.PKT_ORI_BURST_SIZE_H      (122),
		.PKT_ORI_BURST_SIZE_L      (120),
		.PKT_RESPONSE_STATUS_H     (119),
		.PKT_RESPONSE_STATUS_L     (118),
		...
		.rp_data                 (jtag_uart_avalon_jtag_slave_agent_rp_data),                       //  output,  width = 132,                .data
		...
		.cp_data                 (jtag_uart_avalon_jtag_slave_burst_adapter_source0_data),          //   input,  width = 132,                .data
		...
		.cp_channel              (jtag_uart_avalon_jtag_slave_burst_adapter_source0_channel),       //   input,    width = 6,                .channel
		...
		.rf_sink_data            (jtag_uart_avalon_jtag_slave_agent_rsp_fifo_out_data),             //   input,  width = 133,                .data
		...
		.rf_source_data          (jtag_uart_avalon_jtag_slave_agent_rf_source_data),                //  output,  width = 133,                .data
	...
	sys_altera_avalon_sc_fifo_1931_fzgstwy #(
		.SYMBOLS_PER_BEAT    (1),
		.BITS_PER_SYMBOL     (133),
		.FIFO_DEPTH          (2),
		.CHANNEL_WIDTH       (0),
		...
		.clk               (clock_in_out_clk_clk),                                         //   input,    width = 1,       clk.clk
		.reset             (cpu_reset_reset_bridge_in_reset_reset),                        //   input,    width = 1, clk_reset.reset
		.in_data           (jtag_uart_avalon_jtag_slave_agent_rf_source_data),             //   input,  width = 133,        in.data
		...
		.out_data          (jtag_uart_avalon_jtag_slave_agent_rsp_fifo_out_data),          //  output,  width = 133,       out.data
	...
	sys_altera_merlin_slave_agent_191_ncfkfri #(
		...
		.rp_data                 (cpu_dm_agent_agent_rp_data),                       //  output,  width = 132,                .data
		...
		.cp_data                 (cpu_dm_agent_burst_adapter_source0_data),          //   input,  width = 132,                .data
		...
		.cp_channel              (cpu_dm_agent_burst_adapter_source0_channel),       //   input,    width = 6,                .channel
		...
		.rf_sink_data            (cpu_dm_agent_agent_rsp_fifo_out_data),             //   input,  width = 133,                .data
		...
		.rf_source_data          (cpu_dm_agent_agent_rf_source_data),                //  output,  width = 133,                .data
	...
	sys_altera_avalon_sc_fifo_1931_fzgstwy #(
		...
		.clk               (clock_in_out_clk_clk),                          //   input,    width = 1,       clk.clk
		.reset             (cpu_reset_reset_bridge_in_reset_reset),         //   input,    width = 1, clk_reset.reset
		.in_data           (cpu_dm_agent_agent_rf_source_data),             //   input,  width = 133,        in.data
		...
		.out_data          (cpu_dm_agent_agent_rsp_fifo_out_data),          //  output,  width = 133,       out.data
	...
	sys_altera_merlin_slave_agent_191_ncfkfri #(
		...
		.ECC_ENABLE                (0),
		.SYNC_RESET                (0)
	) data_instruction_ram_s1_agent (
		.clk                     (clock_in_out_clk_clk),                                        //   input,    width = 1,             clk.clk
		.reset                   (cpu_reset_reset_bridge_in_reset_reset),                       //   input,    width = 1,       clk_reset.reset
		.m0_address              (data_instruction_ram_s1_agent_m0_address),                    //  output,   width = 32,              m0.address
		.m0_burstcount           (data_instruction_ram_s1_agent_m0_burstcount),                 //  output,    width = 3,                .burstcount
		.m0_byteenable           (data_instruction_ram_s1_agent_m0_byteenable),                 //  output,    width = 4,                .byteenable
		.m0_debugaccess          (data_instruction_ram_s1_agent_m0_debugaccess),                //  output,    width = 1,                .debugaccess
		.m0_lock                 (data_instruction_ram_s1_agent_m0_lock),                       //  output,    width = 1,                .lock
		.m0_readdata             (data_instruction_ram_s1_agent_m0_readdata),                   //   input,   width = 32,                .readdata
		.m0_readdatavalid        (data_instruction_ram_s1_agent_m0_readdatavalid),              //   input,    width = 1,                .readdatavalid
		.m0_read                 (data_instruction_ram_s1_agent_m0_read),                       //  output,    width = 1,                .read
		.m0_waitrequest          (data_instruction_ram_s1_agent_m0_waitrequest),                //   input,    width = 1,                .waitrequest
		.m0_writedata            (data_instruction_ram_s1_agent_m0_writedata),                  //  output,   width = 32,                .writedata
		.m0_write                (data_instruction_ram_s1_agent_m0_write),                      //  output,    width = 1,                .write
		.rp_endofpacket          (data_instruction_ram_s1_agent_rp_endofpacket),                //  output,    width = 1,              rp.endofpacket
		.rp_ready                (data_instruction_ram_s1_agent_rp_ready),                      //   input,    width = 1,                .ready
		.rp_valid                (data_instruction_ram_s1_agent_rp_valid),                      //  output,    width = 1,                .valid
		.rp_data                 (data_instruction_ram_s1_agent_rp_data),                       //  output,  width = 132,                .data
		.rp_startofpacket        (data_instruction_ram_s1_agent_rp_startofpacket),              //  output,    width = 1,                .startofpacket
		.cp_ready                (data_instruction_ram_s1_burst_adapter_source0_ready),         //  output,    width = 1,              cp.ready
		.cp_valid                (data_instruction_ram_s1_burst_adapter_source0_valid),         //   input,    width = 1,                .valid
		.cp_data                 (data_instruction_ram_s1_burst_adapter_source0_data),          //   input,  width = 132,                .data
		.cp_startofpacket        (data_instruction_ram_s1_burst_adapter_source0_startofpacket), //   input,    width = 1,                .startofpacket
		.cp_endofpacket          (data_instruction_ram_s1_burst_adapter_source0_endofpacket),   //   input,    width = 1,                .endofpacket
		.cp_channel              (data_instruction_ram_s1_burst_adapter_source0_channel),       //   input,    width = 6,                .channel
		.rf_sink_ready           (data_instruction_ram_s1_agent_rsp_fifo_out_ready),            //  output,    width = 1,         rf_sink.ready
		.rf_sink_valid           (data_instruction_ram_s1_agent_rsp_fifo_out_valid),            //   input,    width = 1,                .valid
		.rf_sink_startofpacket   (data_instruction_ram_s1_agent_rsp_fifo_out_startofpacket),    //   input,    width = 1,                .startofpacket
		.rf_sink_endofpacket     (data_instruction_ram_s1_agent_rsp_fifo_out_endofpacket),      //   input,    width = 1,                .endofpacket
		.rf_sink_data            (data_instruction_ram_s1_agent_rsp_fifo_out_data),             //   input,  width = 133,                .data
		.rf_source_ready         (data_instruction_ram_s1_agent_rf_source_ready),               //   input,    width = 1,       rf_source.ready
		.rf_source_valid         (data_instruction_ram_s1_agent_rf_source_valid),               //  output,    width = 1,                .valid
		.rf_source_startofpacket (data_instruction_ram_s1_agent_rf_source_startofpacket),       //  output,    width = 1,                .startofpacket
		.rf_source_endofpacket   (data_instruction_ram_s1_agent_rf_source_endofpacket),         //  output,    width = 1,                .endofpacket
		.rf_source_data          (data_instruction_ram_s1_agent_rf_source_data),                //  output,  width = 133,                .data
		.rdata_fifo_sink_ready   (data_instruction_ram_s1_agent_rdata_fifo_out_ready),          //  output,    width = 1, rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (data_instruction_ram_s1_agent_rdata_fifo_out_valid),          //   input,    width = 1,                .valid
		.rdata_fifo_sink_data    (data_instruction_ram_s1_agent_rdata_fifo_out_data),           //   input,   width = 34,                .data
		.rdata_fifo_src_ready    (data_instruction_ram_s1_agent_rdata_fifo_src_ready),          //   input,    width = 1,  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (data_instruction_ram_s1_agent_rdata_fifo_src_valid),          //  output,    width = 1,                .valid
		.rdata_fifo_src_data     (data_instruction_ram_s1_agent_rdata_fifo_src_data),           //  output,   width = 34,                .data
		.m0_response             (2'b00),                                                       // (terminated),                               
		.m0_writeresponsevalid   (1'b0),                                                        // (terminated),                               
		.rdata_fifo_sink_error   (1'b0)                                                         // (terminated),                               
	);
	...
	sys_altera_avalon_sc_fifo_1931_fzgstwy #(
		...
		.EMPTY_WIDTH         (1),
		.SYNC_RESET          (0)
	) data_instruction_ram_s1_agent_rsp_fifo (
		.clk               (clock_in_out_clk_clk),                                     //   input,    width = 1,       clk.clk
		.reset             (cpu_reset_reset_bridge_in_reset_reset),                    //   input,    width = 1, clk_reset.reset
		.in_data           (data_instruction_ram_s1_agent_rf_source_data),             //   input,  width = 133,        in.data
		.in_valid          (data_instruction_ram_s1_agent_rf_source_valid),            //   input,    width = 1,          .valid
		.in_ready          (data_instruction_ram_s1_agent_rf_source_ready),            //  output,    width = 1,          .ready
		.in_startofpacket  (data_instruction_ram_s1_agent_rf_source_startofpacket),    //   input,    width = 1,          .startofpacket
		.in_endofpacket    (data_instruction_ram_s1_agent_rf_source_endofpacket),      //   input,    width = 1,          .endofpacket
		.out_data          (data_instruction_ram_s1_agent_rsp_fifo_out_data),          //  output,  width = 133,       out.data
		.out_valid         (data_instruction_ram_s1_agent_rsp_fifo_out_valid),         //  output,    width = 1,          .valid
		.out_ready         (data_instruction_ram_s1_agent_rsp_fifo_out_ready),         //   input,    width = 1,          .ready
		.out_startofpacket (data_instruction_ram_s1_agent_rsp_fifo_out_startofpacket), //  output,    width = 1,          .startofpacket
		.out_endofpacket   (data_instruction_ram_s1_agent_rsp_fifo_out_endofpacket),   //  output,    width = 1,          .endofpacket
		.csr_address       (2'b00),                                                    // (terminated),                         
		.csr_read          (1'b0),                                                     // (terminated),                         
		.csr_write         (1'b0),                                                     // (terminated),                         
		.csr_readdata      (),                                                         // (terminated),                         
	...
	sys_altera_avalon_sc_fifo_1931_fzgstwy #(
		...
		.EMPTY_WIDTH         (1),
		.SYNC_RESET          (0)
	) data_instruction_ram_s1_agent_rdata_fifo (
		.clk               (clock_in_out_clk_clk),                               //   input,   width = 1,       clk.clk
		.reset             (cpu_reset_reset_bridge_in_reset_reset),              //   input,   width = 1, clk_reset.reset
		.in_data           (data_instruction_ram_s1_agent_rdata_fifo_src_data),  //   input,  width = 34,        in.data
		.in_valid          (data_instruction_ram_s1_agent_rdata_fifo_src_valid), //   input,   width = 1,          .valid
		.in_ready          (data_instruction_ram_s1_agent_rdata_fifo_src_ready), //  output,   width = 1,          .ready
		.out_data          (data_instruction_ram_s1_agent_rdata_fifo_out_data),  //  output,  width = 34,       out.data
		.out_valid         (data_instruction_ram_s1_agent_rdata_fifo_out_valid), //  output,   width = 1,          .valid
		.out_ready         (data_instruction_ram_s1_agent_rdata_fifo_out_ready), //   input,   width = 1,          .ready
		.csr_address       (2'b00),                                              // (terminated),                        
		.csr_read          (1'b0),                                               // (terminated),                        
		.csr_write         (1'b0),                                               // (terminated),                        
		.csr_readdata      (),                                                   // (terminated),                        
	...
	sys_altera_merlin_slave_agent_191_ncfkfri #(
		...
		.clk                     (clock_in_out_clk_clk),                             //   input,    width = 1,             clk.clk
		.reset                   (cpu_reset_reset_bridge_in_reset_reset),            //   input,    width = 1,       clk_reset.reset
		.m0_address              (ram_32bit_s1_agent_m0_address),                    //  output,   width = 32,              m0.address
		.m0_burstcount           (ram_32bit_s1_agent_m0_burstcount),                 //  output,    width = 3,                .burstcount
		.m0_byteenable           (ram_32bit_s1_agent_m0_byteenable),                 //  output,    width = 4,                .byteenable
		.m0_debugaccess          (ram_32bit_s1_agent_m0_debugaccess),                //  output,    width = 1,                .debugaccess
		.m0_lock                 (ram_32bit_s1_agent_m0_lock),                       //  output,    width = 1,                .lock
		.m0_readdata             (ram_32bit_s1_agent_m0_readdata),                   //   input,   width = 32,                .readdata
		.m0_readdatavalid        (ram_32bit_s1_agent_m0_readdatavalid),              //   input,    width = 1,                .readdatavalid
		.m0_read                 (ram_32bit_s1_agent_m0_read),                       //  output,    width = 1,                .read
		.m0_waitrequest          (ram_32bit_s1_agent_m0_waitrequest),                //   input,    width = 1,                .waitrequest
		.m0_writedata            (ram_32bit_s1_agent_m0_writedata),                  //  output,   width = 32,                .writedata
		.m0_write                (ram_32bit_s1_agent_m0_write),                      //  output,    width = 1,                .write
		.rp_endofpacket          (ram_32bit_s1_agent_rp_endofpacket),                //  output,    width = 1,              rp.endofpacket
		.rp_ready                (ram_32bit_s1_agent_rp_ready),                      //   input,    width = 1,                .ready
		.rp_valid                (ram_32bit_s1_agent_rp_valid),                      //  output,    width = 1,                .valid
		.rp_data                 (ram_32bit_s1_agent_rp_data),                       //  output,  width = 132,                .data
		.rp_startofpacket        (ram_32bit_s1_agent_rp_startofpacket),              //  output,    width = 1,                .startofpacket
		.cp_ready                (ram_32bit_s1_burst_adapter_source0_ready),         //  output,    width = 1,              cp.ready
		.cp_valid                (ram_32bit_s1_burst_adapter_source0_valid),         //   input,    width = 1,                .valid
		.cp_data                 (ram_32bit_s1_burst_adapter_source0_data),          //   input,  width = 132,                .data
		.cp_startofpacket        (ram_32bit_s1_burst_adapter_source0_startofpacket), //   input,    width = 1,                .startofpacket
		.cp_endofpacket          (ram_32bit_s1_burst_adapter_source0_endofpacket),   //   input,    width = 1,                .endofpacket
		.cp_channel              (ram_32bit_s1_burst_adapter_source0_channel),       //   input,    width = 6,                .channel
		.rf_sink_ready           (ram_32bit_s1_agent_rsp_fifo_out_ready),            //  output,    width = 1,         rf_sink.ready
		.rf_sink_valid           (ram_32bit_s1_agent_rsp_fifo_out_valid),            //   input,    width = 1,                .valid
		.rf_sink_startofpacket   (ram_32bit_s1_agent_rsp_fifo_out_startofpacket),    //   input,    width = 1,                .startofpacket
		.rf_sink_endofpacket     (ram_32bit_s1_agent_rsp_fifo_out_endofpacket),      //   input,    width = 1,                .endofpacket
		.rf_sink_data            (ram_32bit_s1_agent_rsp_fifo_out_data),             //   input,  width = 133,                .data
		.rf_source_ready         (ram_32bit_s1_agent_rf_source_ready),               //   input,    width = 1,       rf_source.ready
		.rf_source_valid         (ram_32bit_s1_agent_rf_source_valid),               //  output,    width = 1,                .valid
		.rf_source_startofpacket (ram_32bit_s1_agent_rf_source_startofpacket),       //  output,    width = 1,                .startofpacket
		.rf_source_endofpacket   (ram_32bit_s1_agent_rf_source_endofpacket),         //  output,    width = 1,                .endofpacket
		.rf_source_data          (ram_32bit_s1_agent_rf_source_data),                //  output,  width = 133,                .data
		.rdata_fifo_sink_ready   (ram_32bit_s1_agent_rdata_fifo_out_ready),          //  output,    width = 1, rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (ram_32bit_s1_agent_rdata_fifo_out_valid),          //   input,    width = 1,                .valid
		.rdata_fifo_sink_data    (ram_32bit_s1_agent_rdata_fifo_out_data),           //   input,   width = 34,                .data
		.rdata_fifo_src_ready    (ram_32bit_s1_agent_rdata_fifo_src_ready),          //   input,    width = 1,  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (ram_32bit_s1_agent_rdata_fifo_src_valid),          //  output,    width = 1,                .valid
		.rdata_fifo_src_data     (ram_32bit_s1_agent_rdata_fifo_src_data),           //  output,   width = 34,                .data
		.m0_response             (2'b00),                                            // (terminated),                               
		.m0_writeresponsevalid   (1'b0),                                             // (terminated),                               
		.rdata_fifo_sink_error   (1'b0)                                              // (terminated),                               
	);
	...
	sys_altera_avalon_sc_fifo_1931_fzgstwy #(
		...
		.EMPTY_WIDTH         (1),
		.SYNC_RESET          (0)
	) ram_32bit_s1_agent_rsp_fifo (
		.clk               (clock_in_out_clk_clk),                          //   input,    width = 1,       clk.clk
		.reset             (cpu_reset_reset_bridge_in_reset_reset),         //   input,    width = 1, clk_reset.reset
		.in_data           (ram_32bit_s1_agent_rf_source_data),             //   input,  width = 133,        in.data
		.in_valid          (ram_32bit_s1_agent_rf_source_valid),            //   input,    width = 1,          .valid
		.in_ready          (ram_32bit_s1_agent_rf_source_ready),            //  output,    width = 1,          .ready
		.in_startofpacket  (ram_32bit_s1_agent_rf_source_startofpacket),    //   input,    width = 1,          .startofpacket
		.in_endofpacket    (ram_32bit_s1_agent_rf_source_endofpacket),      //   input,    width = 1,          .endofpacket
		.out_data          (ram_32bit_s1_agent_rsp_fifo_out_data),          //  output,  width = 133,       out.data
		.out_valid         (ram_32bit_s1_agent_rsp_fifo_out_valid),         //  output,    width = 1,          .valid
		.out_ready         (ram_32bit_s1_agent_rsp_fifo_out_ready),         //   input,    width = 1,          .ready
		.out_startofpacket (ram_32bit_s1_agent_rsp_fifo_out_startofpacket), //  output,    width = 1,          .startofpacket
		.out_endofpacket   (ram_32bit_s1_agent_rsp_fifo_out_endofpacket),   //  output,    width = 1,          .endofpacket
		.csr_address       (2'b00),                                         // (terminated),                         
		.csr_read          (1'b0),                                          // (terminated),                         
		.csr_write         (1'b0),                                          // (terminated),                         
		.csr_readdata      (),                                              // (terminated),                         
	...
	sys_altera_avalon_sc_fifo_1931_fzgstwy #(
		...
		.EMPTY_WIDTH         (1),
		.SYNC_RESET          (0)
	) ram_32bit_s1_agent_rdata_fifo (
		.clk               (clock_in_out_clk_clk),                    //   input,   width = 1,       clk.clk
		.reset             (cpu_reset_reset_bridge_in_reset_reset),   //   input,   width = 1, clk_reset.reset
		.in_data           (ram_32bit_s1_agent_rdata_fifo_src_data),  //   input,  width = 34,        in.data
		.in_valid          (ram_32bit_s1_agent_rdata_fifo_src_valid), //   input,   width = 1,          .valid
		.in_ready          (ram_32bit_s1_agent_rdata_fifo_src_ready), //  output,   width = 1,          .ready
		.out_data          (ram_32bit_s1_agent_rdata_fifo_out_data),  //  output,  width = 34,       out.data
		.out_valid         (ram_32bit_s1_agent_rdata_fifo_out_valid), //  output,   width = 1,          .valid
		.out_ready         (ram_32bit_s1_agent_rdata_fifo_out_ready), //   input,   width = 1,          .ready
		.csr_address       (2'b00),                                   // (terminated),                        
		.csr_read          (1'b0),                                    // (terminated),                        
		.csr_write         (1'b0),                                    // (terminated),                        
		.csr_readdata      (),                                        // (terminated),                        
	...
	sys_altera_merlin_slave_agent_191_ncfkfri #(
		...
		.clk                     (clock_in_out_clk_clk),                            //   input,    width = 1,             clk.clk
		.reset                   (cpu_reset_reset_bridge_in_reset_reset),           //   input,    width = 1,       clk_reset.reset
		.m0_address              (pio_8bit_s1_agent_m0_address),                    //  output,   width = 32,              m0.address
		.m0_burstcount           (pio_8bit_s1_agent_m0_burstcount),                 //  output,    width = 3,                .burstcount
		.m0_byteenable           (pio_8bit_s1_agent_m0_byteenable),                 //  output,    width = 4,                .byteenable
		.m0_debugaccess          (pio_8bit_s1_agent_m0_debugaccess),                //  output,    width = 1,                .debugaccess
		.m0_lock                 (pio_8bit_s1_agent_m0_lock),                       //  output,    width = 1,                .lock
		.m0_readdata             (pio_8bit_s1_agent_m0_readdata),                   //   input,   width = 32,                .readdata
		.m0_readdatavalid        (pio_8bit_s1_agent_m0_readdatavalid),              //   input,    width = 1,                .readdatavalid
		.m0_read                 (pio_8bit_s1_agent_m0_read),                       //  output,    width = 1,                .read
		.m0_waitrequest          (pio_8bit_s1_agent_m0_waitrequest),                //   input,    width = 1,                .waitrequest
		.m0_writedata            (pio_8bit_s1_agent_m0_writedata),                  //  output,   width = 32,                .writedata
		.m0_write                (pio_8bit_s1_agent_m0_write),                      //  output,    width = 1,                .write
		.rp_endofpacket          (pio_8bit_s1_agent_rp_endofpacket),                //  output,    width = 1,              rp.endofpacket
		.rp_ready                (pio_8bit_s1_agent_rp_ready),                      //   input,    width = 1,                .ready
		.rp_valid                (pio_8bit_s1_agent_rp_valid),                      //  output,    width = 1,                .valid
		.rp_data                 (pio_8bit_s1_agent_rp_data),                       //  output,  width = 132,                .data
		.rp_startofpacket        (pio_8bit_s1_agent_rp_startofpacket),              //  output,    width = 1,                .startofpacket
		.cp_ready                (pio_8bit_s1_burst_adapter_source0_ready),         //  output,    width = 1,              cp.ready
		.cp_valid                (pio_8bit_s1_burst_adapter_source0_valid),         //   input,    width = 1,                .valid
		.cp_data                 (pio_8bit_s1_burst_adapter_source0_data),          //   input,  width = 132,                .data
		.cp_startofpacket        (pio_8bit_s1_burst_adapter_source0_startofpacket), //   input,    width = 1,                .startofpacket
		.cp_endofpacket          (pio_8bit_s1_burst_adapter_source0_endofpacket),   //   input,    width = 1,                .endofpacket
		.cp_channel              (pio_8bit_s1_burst_adapter_source0_channel),       //   input,    width = 6,                .channel
		.rf_sink_ready           (pio_8bit_s1_agent_rsp_fifo_out_ready),            //  output,    width = 1,         rf_sink.ready
		.rf_sink_valid           (pio_8bit_s1_agent_rsp_fifo_out_valid),            //   input,    width = 1,                .valid
		.rf_sink_startofpacket   (pio_8bit_s1_agent_rsp_fifo_out_startofpacket),    //   input,    width = 1,                .startofpacket
		.rf_sink_endofpacket     (pio_8bit_s1_agent_rsp_fifo_out_endofpacket),      //   input,    width = 1,                .endofpacket
		.rf_sink_data            (pio_8bit_s1_agent_rsp_fifo_out_data),             //   input,  width = 133,                .data
		.rf_source_ready         (pio_8bit_s1_agent_rf_source_ready),               //   input,    width = 1,       rf_source.ready
		.rf_source_valid         (pio_8bit_s1_agent_rf_source_valid),               //  output,    width = 1,                .valid
		.rf_source_startofpacket (pio_8bit_s1_agent_rf_source_startofpacket),       //  output,    width = 1,                .startofpacket
		.rf_source_endofpacket   (pio_8bit_s1_agent_rf_source_endofpacket),         //  output,    width = 1,                .endofpacket
		.rf_source_data          (pio_8bit_s1_agent_rf_source_data),                //  output,  width = 133,                .data
		.rdata_fifo_sink_ready   (pio_8bit_s1_agent_rdata_fifo_out_ready),          //  output,    width = 1, rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (pio_8bit_s1_agent_rdata_fifo_out_valid),          //   input,    width = 1,                .valid
		.rdata_fifo_sink_data    (pio_8bit_s1_agent_rdata_fifo_out_data),           //   input,   width = 34,                .data
		.rdata_fifo_src_ready    (pio_8bit_s1_agent_rdata_fifo_src_ready),          //   input,    width = 1,  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (pio_8bit_s1_agent_rdata_fifo_src_valid),          //  output,    width = 1,                .valid
		.rdata_fifo_src_data     (pio_8bit_s1_agent_rdata_fifo_src_data),           //  output,   width = 34,                .data
		.m0_response             (2'b00),                                           // (terminated),                               
		.m0_writeresponsevalid   (1'b0),                                            // (terminated),                               
		.rdata_fifo_sink_error   (1'b0)                                             // (terminated),                               
	);
	...
	sys_altera_avalon_sc_fifo_1931_fzgstwy #(
		...
		.EMPTY_WIDTH         (1),
		.SYNC_RESET          (0)
	) pio_8bit_s1_agent_rsp_fifo (
		.clk               (clock_in_out_clk_clk),                         //   input,    width = 1,       clk.clk
		.reset             (cpu_reset_reset_bridge_in_reset_reset),        //   input,    width = 1, clk_reset.reset
		.in_data           (pio_8bit_s1_agent_rf_source_data),             //   input,  width = 133,        in.data
		.in_valid          (pio_8bit_s1_agent_rf_source_valid),            //   input,    width = 1,          .valid
		.in_ready          (pio_8bit_s1_agent_rf_source_ready),            //  output,    width = 1,          .ready
		.in_startofpacket  (pio_8bit_s1_agent_rf_source_startofpacket),    //   input,    width = 1,          .startofpacket
		.in_endofpacket    (pio_8bit_s1_agent_rf_source_endofpacket),      //   input,    width = 1,          .endofpacket
		.out_data          (pio_8bit_s1_agent_rsp_fifo_out_data),          //  output,  width = 133,       out.data
		.out_valid         (pio_8bit_s1_agent_rsp_fifo_out_valid),         //  output,    width = 1,          .valid
		.out_ready         (pio_8bit_s1_agent_rsp_fifo_out_ready),         //   input,    width = 1,          .ready
		.out_startofpacket (pio_8bit_s1_agent_rsp_fifo_out_startofpacket), //  output,    width = 1,          .startofpacket
		.out_endofpacket   (pio_8bit_s1_agent_rsp_fifo_out_endofpacket),   //  output,    width = 1,          .endofpacket
		.csr_address       (2'b00),                                        // (terminated),                         
		.csr_read          (1'b0),                                         // (terminated),                         
		.csr_write         (1'b0),                                         // (terminated),                         
		.csr_readdata      (),                                             // (terminated),                         
	...
	sys_altera_avalon_sc_fifo_1931_fzgstwy #(
		...
		.EMPTY_WIDTH         (1),
		.SYNC_RESET          (0)
	) pio_8bit_s1_agent_rdata_fifo (
		.clk               (clock_in_out_clk_clk),                   //   input,   width = 1,       clk.clk
		.reset             (cpu_reset_reset_bridge_in_reset_reset),  //   input,   width = 1, clk_reset.reset
		.in_data           (pio_8bit_s1_agent_rdata_fifo_src_data),  //   input,  width = 34,        in.data
		.in_valid          (pio_8bit_s1_agent_rdata_fifo_src_valid), //   input,   width = 1,          .valid
		.in_ready          (pio_8bit_s1_agent_rdata_fifo_src_ready), //  output,   width = 1,          .ready
		.out_data          (pio_8bit_s1_agent_rdata_fifo_out_data),  //  output,  width = 34,       out.data
		.out_valid         (pio_8bit_s1_agent_rdata_fifo_out_valid), //  output,   width = 1,          .valid
		.out_ready         (pio_8bit_s1_agent_rdata_fifo_out_ready), //   input,   width = 1,          .ready
		.csr_address       (2'b00),                                  // (terminated),                        
		.csr_read          (1'b0),                                   // (terminated),                        
		.csr_write         (1'b0),                                   // (terminated),                        
		.csr_readdata      (),                                       // (terminated),                        
	...
	sys_altera_merlin_slave_agent_191_ncfkfri #(
		...
		.rp_data                 (cpu_timer_sw_agent_agent_rp_data),                       //  output,  width = 132,                .data
		...
		.cp_data                 (cpu_timer_sw_agent_burst_adapter_source0_data),          //   input,  width = 132,                .data
		...
		.cp_channel              (cpu_timer_sw_agent_burst_adapter_source0_channel),       //   input,    width = 6,                .channel
		...
		.rf_sink_data            (cpu_timer_sw_agent_agent_rsp_fifo_out_data),             //   input,  width = 133,                .data
		...
		.rf_source_data          (cpu_timer_sw_agent_agent_rf_source_data),                //  output,  width = 133,                .data
	...
	sys_altera_avalon_sc_fifo_1931_fzgstwy #(
		...
		.clk               (clock_in_out_clk_clk),                                //   input,    width = 1,       clk.clk
		.reset             (cpu_reset_reset_bridge_in_reset_reset),               //   input,    width = 1, clk_reset.reset
		.in_data           (cpu_timer_sw_agent_agent_rf_source_data),             //   input,  width = 133,        in.data
		...
		.out_data          (cpu_timer_sw_agent_agent_rsp_fifo_out_data),          //  output,  width = 133,       out.data
	...
	sys_altera_merlin_router_1921_kc7hi3q router (
		...
		.sink_data          (cpu_data_manager_agent_write_cp_data),          //   input,  width = 132,          .data
	...
	sys_altera_merlin_router_1921_kc7hi3q router_001 (
		...
		.sink_data          (cpu_data_manager_agent_read_cp_data),          //   input,  width = 132,          .data
	...
	sys_altera_merlin_router_1921_de7zf3y router_002 (
		...
		.sink_data          (cpu_instruction_manager_agent_write_cp_data),          //   input,  width = 132,          .data
	...
	sys_altera_merlin_router_1921_de7zf3y router_003 (
		...
		.sink_data          (cpu_instruction_manager_agent_read_cp_data),          //   input,  width = 132,          .data
	...
	sys_altera_merlin_router_1921_lkye3cy router_004 (
		...
		.sink_data          (jtag_uart_avalon_jtag_slave_agent_rp_data),          //   input,  width = 132,          .data
	...
	sys_altera_merlin_router_1921_6rd532q router_005 (
		...
		.sink_data          (cpu_dm_agent_agent_rp_data),            //   input,  width = 132,          .data
	...
	sys_altera_merlin_router_1921_6rd532q router_006 (
		.sink_ready         (data_instruction_ram_s1_agent_rp_ready),         //  output,    width = 1,      sink.ready
		.sink_valid         (data_instruction_ram_s1_agent_rp_valid),         //   input,    width = 1,          .valid
		.sink_data          (data_instruction_ram_s1_agent_rp_data),          //   input,  width = 132,          .data
		.sink_startofpacket (data_instruction_ram_s1_agent_rp_startofpacket), //   input,    width = 1,          .startofpacket
		.sink_endofpacket   (data_instruction_ram_s1_agent_rp_endofpacket),   //   input,    width = 1,          .endofpacket
		.clk                (clock_in_out_clk_clk),                           //   input,    width = 1,       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset),          //   input,    width = 1, clk_reset.reset
	...
	sys_altera_merlin_router_1921_lkye3cy router_007 (
		.sink_ready         (ram_32bit_s1_agent_rp_ready),           //  output,    width = 1,      sink.ready
		.sink_valid         (ram_32bit_s1_agent_rp_valid),           //   input,    width = 1,          .valid
		.sink_data          (ram_32bit_s1_agent_rp_data),            //   input,  width = 132,          .data
		.sink_startofpacket (ram_32bit_s1_agent_rp_startofpacket),   //   input,    width = 1,          .startofpacket
		.sink_endofpacket   (ram_32bit_s1_agent_rp_endofpacket),     //   input,    width = 1,          .endofpacket
		.clk                (clock_in_out_clk_clk),                  //   input,    width = 1,       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	sys_altera_merlin_router_1921_lkye3cy router_008 (
		.sink_ready         (pio_8bit_s1_agent_rp_ready),            //  output,    width = 1,      sink.ready
		.sink_valid         (pio_8bit_s1_agent_rp_valid),            //   input,    width = 1,          .valid
		.sink_data          (pio_8bit_s1_agent_rp_data),             //   input,  width = 132,          .data
		.sink_startofpacket (pio_8bit_s1_agent_rp_startofpacket),    //   input,    width = 1,          .startofpacket
		.sink_endofpacket   (pio_8bit_s1_agent_rp_endofpacket),      //   input,    width = 1,          .endofpacket
		.clk                (clock_in_out_clk_clk),                  //   input,    width = 1,       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	sys_altera_merlin_router_1921_lkye3cy router_009 (
		...
		.sink_data          (cpu_timer_sw_agent_agent_rp_data),          //   input,  width = 132,          .data
	...
	sys_altera_merlin_traffic_limiter_191_kcba44q #(
		.SYNC_RESET                (0),
		.PKT_DEST_ID_H             (109),
		.PKT_DEST_ID_L             (107),
		.PKT_SRC_ID_H              (106),
		...
		.cmd_sink_data          (router_002_src_data),                                      //   input,  width = 132,          .data
		...
		.cmd_src_data           (cpu_instruction_manager_wr_limiter_cmd_src_data),          //  output,  width = 132,          .data
		.cmd_src_channel        (cpu_instruction_manager_wr_limiter_cmd_src_channel),       //  output,    width = 6,          .channel
		...
		.rsp_sink_data          (rsp_mux_002_src_data),                                     //   input,  width = 132,          .data
		...
		.rsp_src_data           (cpu_instruction_manager_wr_limiter_rsp_src_data),          //  output,  width = 132,          .data
		.rsp_src_channel        (cpu_instruction_manager_wr_limiter_rsp_src_channel),       //  output,    width = 6,          .channel
		...
		.cmd_src_valid          (cpu_instruction_manager_wr_limiter_cmd_valid_data)         //  output,    width = 6, cmd_valid.data
	);
	...
	sys_altera_merlin_traffic_limiter_191_kcba44q #(
		...
		.cmd_sink_data          (router_003_src_data),                                      //   input,  width = 132,          .data
		...
		.cmd_src_data           (cpu_instruction_manager_rd_limiter_cmd_src_data),          //  output,  width = 132,          .data
		.cmd_src_channel        (cpu_instruction_manager_rd_limiter_cmd_src_channel),       //  output,    width = 6,          .channel
		...
		.rsp_sink_data          (rsp_mux_003_src_data),                                     //   input,  width = 132,          .data
		...
		.rsp_src_data           (cpu_instruction_manager_rd_limiter_rsp_src_data),          //  output,  width = 132,          .data
		.rsp_src_channel        (cpu_instruction_manager_rd_limiter_rsp_src_channel),       //  output,    width = 6,          .channel
		...
		.cmd_src_valid          (cpu_instruction_manager_rd_limiter_cmd_valid_data)         //  output,    width = 6, cmd_valid.data
	);

	sys_altera_merlin_burst_adapter_1923_oaocjua #(
		.PKT_ADDR_H                (67),
		.PKT_ADDR_L                (36),
		.PKT_BEGIN_BURST           (99),
		.PKT_BYTE_CNT_H            (84),
		...
		.sink0_data            (cmd_mux_src_data),                                                //   input,  width = 132,          .data
		...
		.source0_data          (jtag_uart_avalon_jtag_slave_burst_adapter_source0_data),          //  output,  width = 132,          .data
		.source0_channel       (jtag_uart_avalon_jtag_slave_burst_adapter_source0_channel),       //  output,    width = 6,          .channel
	...
	sys_altera_merlin_burst_adapter_1923_oaocjua #(
		...
		.sink0_data            (cmd_mux_001_src_data),                             //   input,  width = 132,          .data
		...
		.source0_data          (cpu_dm_agent_burst_adapter_source0_data),          //  output,  width = 132,          .data
		.source0_channel       (cpu_dm_agent_burst_adapter_source0_channel),       //  output,    width = 6,          .channel
	...
	sys_altera_merlin_burst_adapter_1923_oaocjua #(
		...
		.ADAPTER_VERSION           ("13.1"),
		.SYNC_RESET                (0)
	) data_instruction_ram_s1_burst_adapter (
		.clk                   (clock_in_out_clk_clk),                                        //   input,    width = 1,       cr0.clk
		.reset                 (cpu_reset_reset_bridge_in_reset_reset),                       //   input,    width = 1, cr0_reset.reset
		...
		.source0_valid         (data_instruction_ram_s1_burst_adapter_source0_valid),         //  output,    width = 1,   source0.valid
		.source0_data          (data_instruction_ram_s1_burst_adapter_source0_data),          //  output,  width = 132,          .data
		.source0_channel       (data_instruction_ram_s1_burst_adapter_source0_channel),       //  output,    width = 6,          .channel
		.source0_startofpacket (data_instruction_ram_s1_burst_adapter_source0_startofpacket), //  output,    width = 1,          .startofpacket
		.source0_endofpacket   (data_instruction_ram_s1_burst_adapter_source0_endofpacket),   //  output,    width = 1,          .endofpacket
		.source0_ready         (data_instruction_ram_s1_burst_adapter_source0_ready)          //   input,    width = 1,          .ready
	);
	...
	sys_altera_merlin_burst_adapter_1923_oaocjua #(
		...
		.source0_valid         (ram_32bit_s1_burst_adapter_source0_valid),         //  output,    width = 1,   source0.valid
		.source0_data          (ram_32bit_s1_burst_adapter_source0_data),          //  output,  width = 132,          .data
		.source0_channel       (ram_32bit_s1_burst_adapter_source0_channel),       //  output,    width = 6,          .channel
		.source0_startofpacket (ram_32bit_s1_burst_adapter_source0_startofpacket), //  output,    width = 1,          .startofpacket
		.source0_endofpacket   (ram_32bit_s1_burst_adapter_source0_endofpacket),   //  output,    width = 1,          .endofpacket
		.source0_ready         (ram_32bit_s1_burst_adapter_source0_ready)          //   input,    width = 1,          .ready
	);
	...
	sys_altera_merlin_burst_adapter_1923_oaocjua #(
		...
		.ADAPTER_VERSION           ("13.1"),
		.SYNC_RESET                (0)
	) pio_8bit_s1_burst_adapter (
		.clk                   (clock_in_out_clk_clk),                            //   input,    width = 1,       cr0.clk
		.reset                 (cpu_reset_reset_bridge_in_reset_reset),           //   input,    width = 1, cr0_reset.reset
		.sink0_valid           (cmd_mux_004_src_valid),                           //   input,    width = 1,     sink0.valid
		.sink0_data            (cmd_mux_004_src_data),                            //   input,  width = 132,          .data
		...
		.source0_valid         (pio_8bit_s1_burst_adapter_source0_valid),         //  output,    width = 1,   source0.valid
		.source0_data          (pio_8bit_s1_burst_adapter_source0_data),          //  output,  width = 132,          .data
		.source0_channel       (pio_8bit_s1_burst_adapter_source0_channel),       //  output,    width = 6,          .channel
		.source0_startofpacket (pio_8bit_s1_burst_adapter_source0_startofpacket), //  output,    width = 1,          .startofpacket
		.source0_endofpacket   (pio_8bit_s1_burst_adapter_source0_endofpacket),   //  output,    width = 1,          .endofpacket
		.source0_ready         (pio_8bit_s1_burst_adapter_source0_ready)          //   input,    width = 1,          .ready
	);
	...
	sys_altera_merlin_burst_adapter_1923_oaocjua #(
		...
		.sink0_data            (cmd_mux_005_src_data),                                   //   input,  width = 132,          .data
		...
		.source0_data          (cpu_timer_sw_agent_burst_adapter_source0_data),          //  output,  width = 132,          .data
		.source0_channel       (cpu_timer_sw_agent_burst_adapter_source0_channel),       //  output,    width = 6,          .channel
	...
	sys_altera_merlin_demultiplexer_1921_zi4ncjq cmd_demux (
		.clk                (clock_in_out_clk_clk),                  //   input,    width = 1,       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	sys_altera_merlin_demultiplexer_1921_zi4ncjq cmd_demux_001 (
		.clk                (clock_in_out_clk_clk),                  //   input,    width = 1,       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	sys_altera_merlin_demultiplexer_1921_uhj3cxy cmd_demux_002 (
		.clk                (clock_in_out_clk_clk),                                     //   input,    width = 1,        clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset),                    //   input,    width = 1,  clk_reset.reset
		.sink_ready         (cpu_instruction_manager_wr_limiter_cmd_src_ready),         //  output,    width = 1,       sink.ready
		.sink_channel       (cpu_instruction_manager_wr_limiter_cmd_src_channel),       //   input,    width = 6,           .channel
		.sink_data          (cpu_instruction_manager_wr_limiter_cmd_src_data),          //   input,  width = 132,           .data
		...
		.sink_valid         (cpu_instruction_manager_wr_limiter_cmd_valid_data),        //   input,    width = 6, sink_valid.data
	...
	sys_altera_merlin_demultiplexer_1921_uhj3cxy cmd_demux_003 (
		.clk                (clock_in_out_clk_clk),                                     //   input,    width = 1,        clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset),                    //   input,    width = 1,  clk_reset.reset
		.sink_ready         (cpu_instruction_manager_rd_limiter_cmd_src_ready),         //  output,    width = 1,       sink.ready
		.sink_channel       (cpu_instruction_manager_rd_limiter_cmd_src_channel),       //   input,    width = 6,           .channel
		.sink_data          (cpu_instruction_manager_rd_limiter_cmd_src_data),          //   input,  width = 132,           .data
		...
		.sink_valid         (cpu_instruction_manager_rd_limiter_cmd_valid_data),        //   input,    width = 6, sink_valid.data
		.src0_ready         (cmd_demux_003_src0_ready),                                 //   input,    width = 1,       src0.ready
		.src0_valid         (cmd_demux_003_src0_valid),                                 //  output,    width = 1,           .valid
		.src0_data          (cmd_demux_003_src0_data),                                  //  output,  width = 132,           .data
		...
		.src1_data          (cmd_demux_003_src1_data),                                  //  output,  width = 132,           .data
	...
	sys_altera_merlin_multiplexer_1921_jngkzvq cmd_mux (
		.clk                 (clock_in_out_clk_clk),                  //   input,    width = 1,       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	sys_altera_merlin_multiplexer_1921_wu2ge4i cmd_mux_001 (
		.clk                 (clock_in_out_clk_clk),                  //   input,    width = 1,       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink2_data          (cmd_demux_002_src0_data),               //   input,  width = 132,          .data
		...
		.sink3_data          (cmd_demux_003_src0_data),               //   input,  width = 132,          .data
	...
	sys_altera_merlin_multiplexer_1921_wu2ge4i cmd_mux_002 (
		.clk                 (clock_in_out_clk_clk),                  //   input,    width = 1,       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink2_data          (cmd_demux_002_src1_data),               //   input,  width = 132,          .data
		...
		.sink3_data          (cmd_demux_003_src1_data),               //   input,  width = 132,          .data
	...
	sys_altera_merlin_multiplexer_1921_jngkzvq cmd_mux_003 (
		.clk                 (clock_in_out_clk_clk),                  //   input,    width = 1,       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	sys_altera_merlin_multiplexer_1921_jngkzvq cmd_mux_004 (
		.clk                 (clock_in_out_clk_clk),                  //   input,    width = 1,       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	sys_altera_merlin_multiplexer_1921_jngkzvq cmd_mux_005 (
		.clk                 (clock_in_out_clk_clk),                  //   input,    width = 1,       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	sys_altera_merlin_demultiplexer_1921_t67wuei rsp_demux (
		.clk                (clock_in_out_clk_clk),                  //   input,    width = 1,       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	sys_altera_merlin_demultiplexer_1921_4uzatya rsp_demux_001 (
		.clk                (clock_in_out_clk_clk),                  //   input,    width = 1,       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.src2_data          (rsp_demux_001_src2_data),               //  output,  width = 132,          .data
		...
		.src3_data          (rsp_demux_001_src3_data),               //  output,  width = 132,          .data
	...
	sys_altera_merlin_demultiplexer_1921_4uzatya rsp_demux_002 (
		.clk                (clock_in_out_clk_clk),                  //   input,    width = 1,       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.src2_channel       (rsp_demux_002_src2_channel),            //  output,    width = 6,          .channel
		...
		.src3_data          (rsp_demux_002_src3_data),               //  output,  width = 132,          .data
		.src3_channel       (rsp_demux_002_src3_channel),            //  output,    width = 6,          .channel
	...
	sys_altera_merlin_demultiplexer_1921_t67wuei rsp_demux_003 (
		.clk                (clock_in_out_clk_clk),                  //   input,    width = 1,       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	sys_altera_merlin_demultiplexer_1921_t67wuei rsp_demux_004 (
		.clk                (clock_in_out_clk_clk),                  //   input,    width = 1,       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	sys_altera_merlin_demultiplexer_1921_t67wuei rsp_demux_005 (
		.clk                (clock_in_out_clk_clk),                  //   input,    width = 1,       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	sys_altera_merlin_multiplexer_1921_ue6isla rsp_mux (
		.clk                 (clock_in_out_clk_clk),                  //   input,    width = 1,       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	sys_altera_merlin_multiplexer_1921_ue6isla rsp_mux_001 (
		.clk                 (clock_in_out_clk_clk),                  //   input,    width = 1,       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	sys_altera_merlin_multiplexer_1921_kzbeajq rsp_mux_002 (
		.clk                 (clock_in_out_clk_clk),                  //   input,    width = 1,       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink0_channel       (rsp_demux_001_src2_channel),            //   input,    width = 6,          .channel
		.sink0_data          (rsp_demux_001_src2_data),               //   input,  width = 132,          .data
		...
		.sink1_channel       (rsp_demux_002_src2_channel),            //   input,    width = 6,          .channel
		.sink1_data          (rsp_demux_002_src2_data),               //   input,  width = 132,          .data
	...
	sys_altera_merlin_multiplexer_1921_kzbeajq rsp_mux_003 (
		...
		.sink0_channel       (rsp_demux_001_src3_channel),            //   input,    width = 6,          .channel
		.sink0_data          (rsp_demux_001_src3_data),               //   input,  width = 132,          .data
		...
		.sink1_channel       (rsp_demux_002_src3_channel),            //   input,    width = 6,          .channel
		.sink1_data          (rsp_demux_002_src3_data),               //   input,  width = 132,          .data
